...
//	public static boolean switchToFrameByIndex2(WebDriver driver,int index) {
//		boolean flag = false;
//		try {
...
//	}
	...
	public static void implicitWait(ThreadLocal<RemoteWebDriver> driver, int timeOut) {
	...
	public static void pageLoadTimeOut(ThreadLocal<RemoteWebDriver> driver, int timeOut) {
		((WebDriver) driver).manage().timeouts().pageLoadTimeout(timeOut, TimeUnit.SECONDS);
	}
	...
	public static void WebDriverWait(WebDriver driver, int index) {
		// TODO Auto-generated method stub
